...
namespace scene
{
	...
	private:
		...
		void copyWord(c8* outBuf, s32 bufLenght, c8* word);
		void copyWordLineEnd(c8* outBuf, s32 bufLenght, c8* word);
		void copyWordSpaceEnd(c8* outBuf, s32 bufLenght, c8* word);
