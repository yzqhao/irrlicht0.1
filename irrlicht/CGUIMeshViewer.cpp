...
//! constructor
CGUIMeshViewer::CGUIMeshViewer(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rectEx<s32> rectangle)
...
void CGUIMeshViewer::draw()
{
	...
	core::rectEx<s32> viewPort = AbsoluteRect;
	...
	if (Mesh)
	{
		...
		core::rectEx<s32> oldViewPort = driver->getViewPort();
