...
SceneManager. 
Microsoft Visual C++ 6.0 is used as 
...
do this in Microsift Visual C++ 6.0.
Select the Menu Extras -> Options. Select the directories tab,
and select the 'Include' Item in the combo box.
...
\lib\win32 directory. That's it, with your IDE set up like this,
you will now be able to develop applications with the Irrlicht Engine.
*/
#include <irrlicht.h>
...
void main()
{
	...
	createDevice() has 5 paramters:
	deviceType: Type of the device. This can currently be the Null-device,
	   the Software device, DirectX8 or OpenGL. In this example we use
	   DT_SOFTWARE, but to try out, you might want to change it to
	   DT_NULL, DT_DIRECTX8 or DT_OPENGL. 
	...
	*/
	...
	IrrlichtDevice *device =
		createDevice(DT_SOFTWARE, dimension2d<s32>(512, 384), 16, false, 0);
	...
	*/
	...
	(0, 20, -60). The camera looks from there to (0,0,0).
	*/
